  ...
  return (
    <div className="App">
      ...
      <div>
        ...
        <button className='btn'onClick={allbtn}>All</button>
        <input type='text' placeholder='search task..' value={search} onChange={(e) => setsearch(e.target.value)} className='input'/>
